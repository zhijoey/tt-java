package com.jz.yihua.tt.miniapp.util.crypt;

import com.jz.yihua.toutiao.common.util.crypto.PKCS7Encoder;
...
public class TtMaCryptUtils {
   ...
   * @param ivStr         iv字符串
   */
  public static String decryptByPKCS7(String sessionKey, String encryptedData, String ivStr) {
