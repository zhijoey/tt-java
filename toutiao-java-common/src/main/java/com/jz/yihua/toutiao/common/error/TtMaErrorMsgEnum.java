...
public enum TtMaErrorMsgEnum {
   ...
   * </pre>
   */
  CODE_40002(40002, "access_token无效"),
  /**
   * <pre>
   * touser不是正确的openid.
   ...
   * 对应地址：
   * POST https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token=ACCESS_TOKEN
   * 参考文档地址： https://developer.toutiao.com/dev/miniapp/uYTNz4iN1MjL2UzM
   * </pre>
   */
  CODE_40015(40015, "appid错误"),

  CODE_40017(40017, "secret错误"),
  CODE_40018(40018, "code错误"),
  CODE_40019(40019, "acode错误"),
  CODE_40020(40020, "grant_type不是client_credential"),
  /**
   * <pre>
   * template_id 不正确.
  ...
  TtMaErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  public static String findMsgByCode(int code) {
    for (TtMaErrorMsgEnum value : TtMaErrorMsgEnum.values()) {
      if (value.code == code) {
        return value.msg;
      }
    }
